                        ...
                        <tbody>
                            <?php foreach ($orders as $order): ?>
                                <tr class="<?php echo !empty($order['json_payment_method']) ? 'highlight' : ''; ?>">
                                    ...
                                    <td>
                                        <a href="admin/update_order_payment.php?id=<?php echo $order['order_id']; ?>" class="btn btn-primary btn-sm">Fix</a>
                                        <a href="admin/view_order.php?id=<?php echo $order['order_id']; ?>" class="btn btn-secondary btn-sm">View</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
