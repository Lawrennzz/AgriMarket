...
// Fetch products
$products_query = "SELECT p.product_id, p.name, p.price, p.stock, c.name AS category_name, p.created_at FROM products p JOIN categories c ON p.category_id = c.category_id WHERE p.deleted_at IS NULL ORDER BY p.created_at DESC";
