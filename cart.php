...
if (!empty($_SESSION['cart'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM products WHERE product_id IN ($ids_string)");
    if ($result) {
        $cart_items = $result;
    }
}
    ...
    <div class="cart-container">
                    ...
                    <div class="cart-item" data-product-id="<?php echo $item['product_id']; ?>">
                        ...
                        <div class="item-details">
                            ...
                            <div class="quantity-controls">
                                ...
                                <span class="quantity"><?php echo $_SESSION['cart'][$item['product_id']]; ?></span>
        ...
        <?php } else { ?>
            <div class="empty-cart">
                ...
                <a href="products.php" class="continue-shopping">Return to Products</a>
            </div>
        <?php } ?>
    </div>
